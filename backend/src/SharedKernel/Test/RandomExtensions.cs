...
namespace Test
{
    public static class RandomExtensions
    {
        ...
        /// <summary>
        /// Returns a randomly generated string with the specified length and character set.
        /// </summary>
        public static string NextString(this Random random, int length, bool lettersAndDigitsOnly = false)
        {
            const string chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
            const string allChars = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!@#$%^&*()_+-=[]{}|;':,.<>?";

            var charSet = lettersAndDigitsOnly ? chars : allChars;
